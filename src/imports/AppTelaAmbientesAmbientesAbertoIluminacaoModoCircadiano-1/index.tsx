import svgPaths from "./svg-u4s0293zgn";
import imgEllipse186 from "./aa2d1113b1e32cf249aca3b9ce7c43c8ce970f30.png";
  ...
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center justify-center relative shrink-0 w-full" data-name="Color Wheel Container">
      <div className="relative shrink-0 size-[300px]">
        <div className="absolute inset-[0_0_12.95%_0]">
          <img alt="" className="block max-w-none size-full" height="261.157" src={imgEllipse186} width="300" />
        </div>
      </div>
      <div className="absolute left-[148px] size-[36px] top-[7px]">
        <div className="absolute inset-[-11.11%_-22.22%_-33.33%_-22.22%]">
          <svg className="block size-full" fill="none" height="52" preserveAspectRatio="none" viewBox="0 0 52 52" width="52">
            <g filter="url(#filter0_d_0_341)" id="Ellipse 184">
              <circle cx="26" cy="22" r="16.5" shapeRendering="crispEdges" stroke="white" strokeWidth="3" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="52" id="filter0_d_0_341" width="52" x="0" y="0">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Montserrat:SemiBold',sans-serif] font-semibold h-[42px] justify-center leading-[0] left-[165.5px] text-[24px] text-center text-white top-[150px] w-[123px]">
        <p className="leading-[normal]">4000K</p>
      </div>
    </div>
  );
}
...
function Conteudo() {
  return (
    <div className="content-stretch flex flex-col gap-[48px] items-start relative shrink-0 w-full" data-name="conteúdo">
      <AppItemDeListaCaixaDeSelecao className="relative shrink-0 w-full" textoDoItem="Ativar iluminação circadiana" />
      <ColorWheelContainer />
      <Frame />
    </div>
  );
